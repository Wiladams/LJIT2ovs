...
--[[
#ifdef SWIG
exports.OFP_ASSERT(EXPR)        /* SWIG can't handle OFP_ASSERT. */
#elif !defined(__cplusplus)
/* Build-time assertion for use in a declaration context. */
exports.OFP_ASSERT(EXPR)                                                \
        extern int (*build_assert(void))[ sizeof(struct {               \
                    unsigned int build_assert_failed : (EXPR) ? 1 : -1; })]
#else /* __cplusplus */
#include <boost/static_assert.hpp>
exports.OFP_ASSERT BOOST_STATIC_ASSERT
#endif /* __cplusplus */
--]]
local exports = {}

local function OFP_ASSERT(...)
    assert(...)
end
exports.OFP_ASSERT = OFP_ASSERT;
...
exports.OF_VENDOR_ID    = 0;
exports.HPL_VENDOR_ID   = 0x000004EA; -- HP Labs.
exports.NTR_VENDOR_ID   = 0x00001540; -- Netronome.
exports.NX_VENDOR_ID    = 0x00002320; -- Nicira.
exports.ONF_VENDOR_ID   = 0x4f4e4600; -- Open Networking Foundation.


exports.OFP_OLD_PORT  = 6633;
exports.OFP_PORT  = 6653;

ffi.cdef[[
static const int OFP_MAX_TABLE_NAME_LEN = 32;
static const int OFP_MAX_PORT_NAME_LEN  = 16;
static const int OFP_ETH_ALEN = 6;          // Bytes in an Ethernet address. 
]]

exports.OFP_DEFAULT_MISS_SEND_LEN   = 128;
 ...
 */
--]]
exports.OFP_DL_TYPE_ETH2_CUTOFF   = 0x0600;
 ...
 */
--]]
exports.OFP_DL_TYPE_NOT_ETH_TYPE  = 0x05ff;

--[[
 Value used in "idle_timeout" and "hard_timeout" to indicate that the entry
 * is permanent.
--]]
exports.OFP_FLOW_PERMANENT = 0;

-- By default, choose a priority in the middle.
exports.OFP_DEFAULT_PRIORITY = 0x8000;
...
OFP_ASSERT(ffi.sizeof("struct ofp_header") == 8);
...
OFP_ASSERT(ffi.sizeof("struct ofp_queue_prop_header") == 8);
...
OFP_ASSERT(ffi.sizeof("struct ofp_queue_prop_rate") == 16);
...
OFP_ASSERT(ffi.sizeof("struct ofp_switch_features") == 24);
...
OFP_ASSERT(ffi.sizeof("struct ofp_port_status") == 8);
...
ffi.cdef[[
static const int DESC_STR_LEN  = 256;
static const int SERIAL_NUM_LEN = 32;
...
OFP_ASSERT(ffi.sizeof("struct ofp_desc_stats") == 1056);
...
OFP_ASSERT(ffi.sizeof("struct ofp_aggregate_stats_reply") == 24);
...
OFP_ASSERT(ffi.sizeof("struct ofp_hello_elem_header") == 4);
...
OFP_ASSERT(ffi.sizeof("struct ofp_vendor_header") == 12);
